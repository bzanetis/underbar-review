(function() {
  ...
  //run iterator with coll[i] or coll[key]
  ...
  // declare an empty arr & emty obj
  // use a for loop to iterate
  // if obj[i] doesn't exist, assign key and val
  // for in loop
  // push all vals to array & return array
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (key in obj) {
        ...
        return (obj[key] = func.apply(null, arguments));
      }
    };
  };
